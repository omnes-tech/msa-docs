...
<div className="mt-8 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
  <div className="text-yellow-800 dark:text-yellow-200">
    <strong className="text-yellow-900 dark:text-yellow-100">💡 Still Having Issues?</strong> Check our GitHub issues, join our Discord community, or [contact our support team](https://calendly.com/omnes-blockchain/30min) for assistance.
  </div>
</div>
