...
<div className="mt-8 p-4 bg-purple-50 rounded-lg">
  <div className="text-purple-800">
    <strong>💡 Need Help Choosing?</strong> [Contact our team](https://calendly.com/omnes-blockchain/30min) for guidance on selecting the right custody type for your application. We can help you evaluate your security requirements and recommend the best configuration.
  </div>
</div>
