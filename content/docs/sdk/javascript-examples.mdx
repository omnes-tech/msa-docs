...
description: Complete JavaScript examples for using the MSA API with fetch and native browser APIs.
---

# JavaScript Examples

Complete JavaScript examples for integrating MSA API into your web applications using native browser APIs and fetch.
