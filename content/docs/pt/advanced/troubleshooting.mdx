...
<div className="mt-8 p-4 bg-yellow-50 rounded-lg">
  <div className="text-yellow-800">
    <strong>💡 Ainda com Problemas?</strong> Verifique nossas issues no GitHub, junte-se à nossa comunidade no Discord, ou [entre em contato com nossa equipe de suporte](https://calendly.com/omnes-blockchain/30min) para assistência.
  </div>
</div>
