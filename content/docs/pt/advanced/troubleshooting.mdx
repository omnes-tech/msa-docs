...
description: Problemas comuns, códigos de erro e soluções para integração com a API MSA.
---

Problemas comuns e soluções ao trabalhar com a API MSA.
...
**Causas**:
- Endereço de carteira previsto não tem tokens nativos suficientes
- Estimativa de gas falhou devido a saldo baixo
...
- **Email Support**: [Entre em contato com nossa equipe de suporte](https://calendly.com/omnes-blockchain/30min)
...
- **[Recursos Avançados](/docs/advanced/multisig)** - Saiba mais sobre recursos avançados
- **[Referência da API](/docs/api-reference/interactive-docs)** - Explore os endpoints da API

---

<div className="mt-8 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
  <div className="text-yellow-800 dark:text-yellow-200">
    <strong className="text-yellow-900 dark:text-yellow-100">💡 Ainda com Problemas?</strong> Verifique nossas issues no GitHub, junte-se à nossa comunidade no Discord, ou [entre em contato com nossa equipe de suporte](https://calendly.com/omnes-blockchain/30min) para assistência.
  </div>
</div>
